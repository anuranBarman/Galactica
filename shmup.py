...
player_expl_sound=pygame.mixer.Sound("./rumble1.ogg")
shoot_sound=pygame.mixer.Sound("./shoot.wav")
shield_power_sound=pygame.mixer.Sound("./shield_power.ogg")
bullet_power_sound=pygame.mixer.Sound("./bullet_power.ogg")
exp_sounds=[]
for sound in ['small_m.wav','big_m.wav']:
    exp_sounds.append(pygame.mixer.Sound(sound))
pygame.mixer.music.load("bg_sound.ogg")
